...
import { Class, ClassSchedule, ClassBooking, ClassType, ClassDifficulty, ClassStatus, BookingStatus, DayOfWeek } from '@prisma/client'
...
export interface BookClassData {
  scheduleId: string
  memberId: string
  bookingType?: 'REGULAR' | 'DROP_IN' | 'TRIAL' | 'COMPLIMENTARY'
  notes?: string
}
