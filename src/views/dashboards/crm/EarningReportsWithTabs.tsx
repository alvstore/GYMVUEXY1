...
type TabCategory = 'memberships' | 'revenue' | 'classes' | 'trainers'
...
const tabData: TabType[] = [
  {
    ...
    series: [{ data: [45, 52, 68, 72, 65, 82, 90, 97, 110] }]
  },
  {
    type: 'revenue',
    avatarIcon: 'tabler-currency-dollar',
    series: [{ data: [28, 32, 48, 52, 45, 65, 78, 85, 95] }]
  },
  {
    type: 'classes',
    avatarIcon: 'tabler-calendar',
    series: [{ data: [15, 22, 30, 35, 28, 42, 50, 55, 60] }]
  },
  {
    type: 'trainers',
    avatarIcon: 'tabler-dumbbell',
    series: [{ data: [5, 8, 12, 15, 18, 22, 25, 28, 30] }]
  }
]
...
const EarningReportsWithTabs = () => {
  // States
  const [value, setValue] = useState<TabCategory>('memberships')
  ...
  const options: ApexOptions = {
    ...
    dataLabels: {
      offsetY: -11,
      formatter: val => value === 'revenue' ? `$${val}k` : `${val}`,
      style: {
        fontWeight: 500,
  ...
  return (
    <Card>
      <CardHeader
        ...
        subheader='Monthly Statistics Overview'
